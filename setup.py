...
REQUIRED = ["numpy>=1.21.6,<2.0.0", "PyYAML==6.0", "pims==0.6.1", "tqdm==4.66.1", "natsort==8.2.0", "gdown==4.6.0",
            "torch>=2.2.1,<3.0.0", "torchvision>=0.17.1,<1.0.0", "timm==0.6.13", "transforms3d==0.4.1", "pyproj>=3.2.0",
            "overrides==7.3.1", "pandas>=2.1.3,<3.0.0", "matplotlib==3.7.1", "flow_vis==0.1", "colorama==0.4.6",
