...
class EncoderMap2Map(FeedForwardNetwork):
	...
	def __str__(self):
		return f"Encoder Map2Map. dIn: {self.dIn}. NF: {self.numFilters}. Params: {self.getNumParams()[1]})"
...
class DecoderMap2Map(FeedForwardNetwork):
	...
	def __str__(self):
		return f"Decoder Map2Map. dOut: {self.dOut}. NF: {self.numFilters}. Params: {self.getNumParams()[1]})"
