...
from ..comm import all_gather, get_rank, get_world_size, synchronize
...
class DataLoaderBenchmark:
    ...
    def __init__(
        ...
        *,
        ...
        self.per_gpu_batch_size = self.total_batch_size // get_world_size()
    ...
    def _log_time(self, msg, avg, all_times, distributed=False):
        ...
        if not distributed:
            ...
            return
        avg_per_gpu = all_gather(avg)
        percentiles_per_gpu = all_gather(percentiles)
        if get_rank() > 0:
            return
