...
```bash
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb.yaml --output_size 540 960 --disable_hud > /dev/null
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb_safeuav_150k.yaml --output_size 540 1920 --disable_hud > /dev/null
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb_safeuav_430k.yaml --output_size 540 1920 --disable_hud > /dev/null
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb_safeuav_1M.yaml --output_size 540 1920 --disable_hud > /dev/null
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb_safeuav_4M.yaml --output_size 540 1920 --disable_hud > /dev/null
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb_dpt.yaml --output_size 540 1920 --disable_hud > /dev/null
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb_mask2former.yaml --output_size 540 1920 --disable_hud > /dev/null
VRE_DEVICE=cuda vre_streaming video_540_960.mp4 cfg_rgb_marigold.yaml --output_size 540 1920 --disable_hud > /dev/null
```