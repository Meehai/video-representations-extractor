...
from vre.representations.mixins import LearnedRepresentationMixin, NpIORepresentationMixin, ResizableRepresentationMixin
from vre_video import VREVideo

class MyRepresentation(LearnedRepresentationMixin, NpIORepresentationMixin,
...
class MyDependentRepresentation(NpIORepresentationMixin, ResizableRepresentationMixin, Representation):
    def __init__(self, *args, **kwargs):
        NpIORepresentationMixin.__init__(self)
        ResizableRepresentationMixin.__init__(self)
        Representation.__init__(self, *args, **kwargs)
